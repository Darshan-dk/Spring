...
<body>
<div class="bag-img"><nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <a
		class="navbar-brand" href="#">E-Commerce</a> <a class="navbar-brand"
		href="LoginPage.jsp">Login</a> </nav>
	...
	<a class="navbar-brand " href="#"><small>@Copyright Xworkz-2021
			</small></a> </nav>
</body>
</html>
